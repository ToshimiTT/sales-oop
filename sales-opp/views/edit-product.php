<?php 
    ...
    include "../classes/Product.php"; // import product class into our file

    $product = new Product; //create a new object based on the product class
    $id = $_GET['product_id']; //get product id from the URL
    $product_details = $product->displaySpecificProduct($id); //get product details from the database
    ...
    <div class="container mt-5">
        <div class="card border-0 mx-auto w-50">
            <div class="card-header border-0 bg-white mt-5">
                <h1 class="display-4 text-center text-warning">Edit Product</h1>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <button type="submit" class="btn btn-warning w-100" name="edit_product">Save</button>
                </div>
            </div>
                </form>
            </div>
